...
class TermController(Controller):
    ...
    @get("/project/{project_id:uuid}", summary="Get by Project", return_dto=TermDTO)
    ...
    @get("/question/{question_id:uuid}", summary="Get by Question", return_dto=PassageDTO)
    ...
    @put("/add/{question_id:uuid}", summary="Add to Question", return_dto=PassageDTO)
    ...
    @put("/remove/{question_id:uuid}", summary="Remove from Question", dto=AnnotationRemoveDTO, return_dto=PassageDTO)
    ...
    @get("/{project_id:uuid}/{term_id:uuid}", summary="Get by Term", return_dto=QuestionOverviewDTO)
